...
def run_requirements_agent(spec: str):
...
def run_schema_agent(req: Requirements):
...
def run_api_agent(req: Requirements, schema: SchemaDesign):
...
def run_frontend_agent(req: Requirements, api: ApiDesign):
...
def run_sprint_agent(req: Requirements, schema: SchemaDesign, api: ApiDesign, fe: FrontendDesign):
